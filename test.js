...
assert(products.length === 3,           "GET /product failed: Unexpected number of products.")
assert(product.name === "Product 1",    "GET /product/1 failed: Unexpected product name.")
assert(blogs.length === 2,              "GET /blog failed: Unexpected number of blog posts.")
assert(blog.title === "A blog post",    "GET /blog/1 failed: Unexpected blog post title.")
